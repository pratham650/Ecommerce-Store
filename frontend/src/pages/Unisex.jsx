...
import unisexProduct from "../data/unisexProducts";
...
const Unisex = () => {
  ...
  const styleOptions = ["Oversized", "Typography"];
  ...
  const filteredProducts = useMemo(() => {
    const result = unisexProduct.filter((product) => {
      const styleMatch =
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white p-4 md:p-10">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <aside className="md:w-1/4 w-full">
          <button
            className="md:hidden bg-purple-600 text-white w-full py-2 rounded mb-4"
          ...
          {(showFilter || window.innerWidth >= 768) && (
            <div className="bg-white rounded-xl shadow-md p-5 border border-purple-200 sticky top-4 h-fit">
              <h3 className="text-xl font-semibold text-purple-600 mb-4 border-b pb-2">Filters</h3>
